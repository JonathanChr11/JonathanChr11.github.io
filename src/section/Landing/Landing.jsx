...
const Landing = () => {
    ...
    return(
        <section ref={landingRef} id="homeSection">
            <div className="landing-container" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div className="landing-container-right">
                    <div className="contents">
                        <p className="contents-name">
                            Hello I'am<br /><span className="names">Jonathan Christian</span></p>
                    ...
                    <div className="profile">
                        ...
                        />
                        <Button
                            btnLink={"https://www.linkedin.com/in/jonathan-christian-286478220/"}
